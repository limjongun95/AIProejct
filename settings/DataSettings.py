...
PATH_TO_TRAIN_SET_CATELOG = './datafile/catelog/train.txt'
PATH_TO_VAL_SET_CATELOG   = './datafile/catelog/val.txt'
PATH_TO_TEST_SET_CATELOG  = './datafile/catelog/test.txt'
