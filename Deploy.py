...
PATH_FILE_NAME_OF_SOURCE_VIDEO = 'C:/Users/USER/Desktop/ai_test/인공지능_test/ViolenceDetection-master/datafile/cctv/cctv.mp4'
...
if __name__ == '__main__':
	# if len(sys.argv) >= 2:
	if len(['sys.argv','fuck']) >= 2:
		# PATH_FILE_NAME_OF_SOURCE_VIDEO = sys.argv[1]
		PATH_FILE_NAME_OF_SOURCE_VIDEO = 'C:/Users/USER/Desktop/test_2.avi'
